...
const CanViewNavGroup = (props: Props) => {
  ...
  const canViewMenuGroup = (item: NavGroup) => {
    const hasAnyVisibleChild =
      ...
      item.children.some((i: NavLink) => {
        // Assuming NavLinks has a visibility logic based on moduleId and gameIds
        // Replace this with your actual logic from NavLinks
        const isVisible = i?.moduleId as any
        return isVisible;
      });
